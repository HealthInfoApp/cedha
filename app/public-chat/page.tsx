      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden bg-white">
        ...
        <header className="border-b border-slate-200 px-4 py-3 flex items-center justify-between bg-white shadow-sm md:px-6">
          <button
            ...
            className="md:hidden p-2.5 rounded-lg bg-emerald-100 hover:bg-emerald-200 text-emerald-700 transition-all duration-200 shadow-sm hover:shadow-md"
          >
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="text-xs md:text-sm text-slate-500 flex items-center gap-2 px-2 md:px-3 py-1 bg-amber-50 rounded-full border border-amber-200">
              ...
              <span className="text-amber-700 font-medium hidden md:inline">{MESSAGE_LIMIT - messageCount} left</span>
              <span className="text-amber-700 font-medium md:hidden">{MESSAGE_LIMIT - messageCount}</span>
            </div>
